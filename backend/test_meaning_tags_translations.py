...
def test_ui_translations_by_meaning_tags():
    """Test getting UI translations by meaning tags"""
    # First, create a meaning with a langmap gloss and tag
    meaning_payload = {
...
if __name__ == "__main__":
    print("Testing meaning tags-based UI translations...")
    test_ui_translations_by_meaning_tags()