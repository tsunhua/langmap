...
('en', 'English', 'GB', 'London, United Kingdom', 51.5074, -0.1278, datetime('now'), datetime('now')),
('zh-Hans', '简体中文', 'CN', '北京，中国', 39.9042, 116.4074, datetime('now'), datetime('now')),
('zh-Hant', '繁體中文', 'TW', '台北，台灣', 25.0330, 121.5654, datetime('now'), datetime('now')),
