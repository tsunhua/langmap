    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
      ...
      <div class="mb-6">
          ...
          <textarea
            v-model="text"
            rows="4"
            class="block w-full rounded-md border border-slate-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 py-3 px-4 text-slate-800"
            ...
            <div class="flex gap-2">
              <div class="relative flex-1">
                <select
                  ...
                  class="block w-full rounded-md border border-slate-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 py-3 px-3 appearance-none text-slate-800"
...
export default {
  ...
  setup() {
    ...
    const updateRegionFromInput = () => {
      ...
      region.value = geoInfo ? geoInfo.name : ''
    }
    
    watch(regionInput, updateRegionFromInput)
