  ...
  it('shows the anchor expression readings under the title', async () => {
    ...
    detail.mockResolvedValue({
      ...
      readings: [
        ...
        { language_locale_code: 'cmn-Hant-TW', locale_display_name: 'Mandarin', scheme: 'pinyin', value: 'nántiě' },
    ...
    expect(readings[0].find('.anchor-reading-locale').text()).toBe('(CN, TW · Mandarin)')
