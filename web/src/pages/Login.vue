<template>
  <div class="min-h-screen flex items-start justify-center pt-16 sm:pt-24 px-4 sm:px-6 lg:px-8 bg-slate-50">
    <div class="max-w-md w-full space-y-8">
      <div>
        <h2 class="mt-2 sm:mt-6 text-center text-3xl font-extrabold text-slate-900">
          {{ $t('login_title') }}
        </h2>
